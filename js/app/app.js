...
var $author$project$App$MainPage = F2(
	function (a, b) {
		return {$: 'MainPage', a: a, b: b};
	});
var $author$project$App$prog = 'TEMP    DC    0\nA    DC    8\nB    DC    -2\nC    DC    3\nLOAD    B\nMULT    C\nADD    A\nDIV    B\nSUB    A\nSTORE    TEMP\nEND';
var $author$project$App$initialModel = {
	rawCode: $author$project$App$prog,
	state: A2($author$project$App$MainPage, '', '')
};
var $elm$core$Platform$Sub$batch = _Platform_batch;
var $elm$core$Platform$Sub$none = $elm$core$Platform$Sub$batch(_List_Nil);
var $author$project$App$Executing = function (a) {
	return {$: 'Executing', a: a};
};
var $author$project$App$Value = function (a) {
	return {$: 'Value', a: a};
};
var $elm$core$String$lines = _String_lines;
var $author$project$App$Label = function (a) {
	return {$: 'Label', a: a};
};
...
var $author$project$App$Immediate = function (a) {
	return {$: 'Immediate', a: a};
};
var $author$project$App$Reference = function (a) {
	return {$: 'Reference', a: a};
};
var $author$project$App$canUseImmediateData = function (opcode) {
	switch (opcode.$) {
		case 'Load':
			return true;
		case 'Operator':
...
var $author$project$App$parseLocation = F2(
	function (opcode, loc) {
		return A2(
			$elm$core$Maybe$withDefault,
			$author$project$App$Reference(
				$author$project$App$Label(loc)),
			A2(
				$elm$core$Maybe$map,
				function (n) {
					return $author$project$App$canUseImmediateData(opcode) ? $author$project$App$Immediate(
						$author$project$App$Value(n)) : $author$project$App$Reference(
						$author$project$App$Label(loc));
				},
				$elm$core$String$toInt(loc)));
	});
var $author$project$App$Branch = function (a) {
	return {$: 'Branch', a: a};
};
var $author$project$App$Dc = {$: 'Dc'};
var $author$project$App$End = {$: 'End'};
var $author$project$App$Load = {$: 'Load'};
var $author$project$App$Operator = function (a) {
	return {$: 'Operator', a: a};
};
...
var $author$project$App$liftOp = F3(
	function (op, _v0, _v1) {
		var a = _v0.a;
		var b = _v1.a;
		return $author$project$App$Value(
			A2(op, a, b) % $author$project$App$limit);
	});
...
var $author$project$App$parseOpcode = function (word) {
	switch (word) {
		case 'LOAD':
			return $elm$core$Maybe$Just($author$project$App$Load);
		case 'STORE':
			return $elm$core$Maybe$Just($author$project$App$Store);
		case 'ADD':
			return $elm$core$Maybe$Just(
				$author$project$App$Operator(
					$author$project$App$liftOp($elm$core$Basics$add)));
		case 'SUB':
			return $elm$core$Maybe$Just(
				$author$project$App$Operator(
					$author$project$App$liftOp($elm$core$Basics$sub)));
		case 'MULT':
			return $elm$core$Maybe$Just(
				$author$project$App$Operator(
					$author$project$App$liftOp($elm$core$Basics$mul)));
		case 'DIV':
			return $elm$core$Maybe$Just(
				$author$project$App$Operator(
					$author$project$App$liftOp($elm$core$Basics$idiv)));
		case 'BG':
			return $elm$core$Maybe$Just(
				$author$project$App$Branch(
					A2(
						$author$project$App$liftOpB,
						$elm$core$Basics$gt,
						$author$project$App$Value(0))));
		case 'BE':
			return $elm$core$Maybe$Just(
				$author$project$App$Branch(
					A2(
			...
			return $elm$core$Maybe$Just(
				$author$project$App$Branch(
					A2(
						...
						$author$project$App$Value(0))));
		case 'READ':
			return $elm$core$Maybe$Just($author$project$App$Read);
		case 'PRINT':
			return $elm$core$Maybe$Just($author$project$App$Print);
		case 'DC':
...
var $author$project$App$parseLineData = F4(
	function (lineNumber, label, opcodeStr, locStr) {
		return A2(
			...
			function (opcode) {
				return A2(
					...
					function (loc) {
						return $elm$core$Maybe$Just(
							{
								label: A2($elm$core$Maybe$map, $author$project$App$Label, label),
					...
					$elm$core$Maybe$Just(
						A2($author$project$App$parseLocation, opcode, locStr)));
			},
			$author$project$App$parseOpcode(opcodeStr));
	});
			...
			function (_v0, acc) {
				...
				if (_v1.a.$ === 'Just') {
					if (_v1.b.$ === 'Ok') {
						...
						var carryLine = _v1.b.a;
						return $elm$core$Result$Err(carryLine);
					}
				} else {
					var _v2 = _v1.a;
					return $elm$core$Result$Err(lineNum);
				}
			}),
		...
		A2(
			...
			F2(
				function (i, line) {
					return _Utils_Tuple2(
						i,
						A2($author$project$App$parseLine, i, line));
				}),
			lines));
};
var $author$project$App$startingState = F2(
	function (inputData, program) {
		return {
			acc: $author$project$App$Value(0),
			input: inputData,
			lineNumber: 0,
			memory: $elm$core$Dict$empty,
			printed: _List_Nil,
			program: program
		};
	});
...
var $author$project$App$Finished = function (a) {
	return {$: 'Finished', a: a};
};
var $author$project$App$Success = function (a) {
	return {$: 'Success', a: a};
};
...
var $author$project$App$getValue = F3(
	function (loc, machineState, canUseImmediate) {
		if (loc.$ === 'Immediate') {
			var val = loc.a;
			return canUseImmediate ? $elm$core$Result$Ok(val) : $elm$core$Result$Err('Cannot use immediate data');
		} else {
			var label = loc.a.a;
			var _v1 = A2($elm$core$Dict$get, label, machineState.memory);
			if (_v1.$ === 'Just') {
				var val = _v1.a;
				return $elm$core$Result$Ok(val);
			} else {
				return $elm$core$Result$Err('Uninitialized label');
			}
		}
	});
var $elm$core$Debug$log = _Debug_log;
var $author$project$App$setAtLocation = F3(
	function (memory, location, value) {
		if (location.$ === 'Immediate') {
			return $elm$core$Result$Err('Cannot set immediate data');
		} else {
			var label = location.a.a;
			return $elm$core$Result$Ok(
				A3($elm$core$Dict$insert, label, value, memory));
		}
	});
var $author$project$App$executeLine = F2(
	function (line, machineStat) {
		var l = A2($elm$core$Debug$log, 'executeLine', line);
		var getVal = function (opcode) {
			return A3(
				$author$project$App$getValue,
				line.location,
				machineStat,
				$author$project$App$canUseImmediateData(opcode));
		};
		var bind = F2(
			function (f, r) {
				if (r.$ === 'Err') {
					var e = r.a;
					return $author$project$App$Error(e);
				} else {
					var v = r.a;
					return f(v);
				}
			});
		var advance = function (config) {
			return _Utils_update(
				config,
		...
		switch (_v0.$) {
			...
			case 'Store':
				return A2(
					...
					A3($author$project$App$setAtLocation, machineStat.memory, line.location, machineStat.acc));
			case 'Operator':
				var op = _v0.a;
				return A2(
					bind,
					function (v) {
						var _v1 = A2($elm$core$Debug$log, 'v', v);
						var _v2 = A2($elm$core$Debug$log, 'machineStat.acc', machineStat.acc);
						var _v3 = A2(
							$elm$core$Debug$log,
							'new acc',
							A2(op, machineStat.acc, v));
						return $author$project$App$Success(
							advance(
								_Utils_update(
									machineStat,
									{
										acc: A2(op, machineStat.acc, v)
									})));
					},
					getVal(line.opcode));
			case 'Branch':
				var bop = _v0.a;
				var _v4 = line.location;
				if (_v4.$ === 'Immediate') {
					return $author$project$App$Error('Branch without label');
				} else {
					var lbl = _v4.a;
					var _v5 = A2(
						$elm$core$Maybe$andThen,
						function (targetLabel) {
							return A2(
								...
								function (lin) {
									return _Utils_eq(
										lin.label,
										$elm$core$Maybe$Just(targetLabel));
								},
								machineStat.program);
						},
						A2(bop, machineStat.acc, lbl));
					if (_v5.$ === 'Nothing') {
						return $author$project$App$Success(
							advance(machineStat));
					} else {
						var targetLineNumber = _v5.a;
						return $author$project$App$Success(
							_Utils_update(
								machineStat,
			...
			case 'Read':
				var _v6 = machineStat.input;
				if (!_v6.b) {
					return $author$project$App$Error('No input');
				} else {
					var x = _v6.a;
					var xs = _v6.b;
					return A2(
			...
			case 'Dc':
				var _v7 = line.label;
				if (_v7.$ === 'Nothing') {
					return $author$project$App$Error('Dc without label');
				} else {
					var lbl = _v7.a;
					var _v8 = line.location;
					if (_v8.$ === 'Immediate') {
						var v = _v8.a.a;
						return A2(
							bind,
							...
							A3(
								$author$project$App$setAtLocation,
								machineStat.memory,
								$author$project$App$Reference(lbl),
								$author$project$App$Value(v)));
					} else {
						return $author$project$App$Error('Dc without value');
					}
				}
			default:
				return $author$project$App$Finished(machineStat);
		}
	});
...
var $author$project$App$getLine = function (machineState) {
	return A2($elm_community$list_extra$List$Extra$getAt, machineState.lineNumber, machineState.program);
};
var $author$project$App$step = function (_v0) {
	var machineState = _v0.machineState;
	var program = _v0.program;
	var _v1 = $author$project$App$getLine(machineState);
	if (_v1.$ === 'Nothing') {
		return $author$project$App$Finished(machineState);
	} else {
		var line = _v1.a;
		var _v2 = A2($author$project$App$executeLine, line, machineState);
		switch (_v2.$) {
			case 'Error':
				var err = _v2.a;
				return $author$project$App$Error(
					_Utils_Tuple2(machineState.lineNumber, err));
			case 'Success':
				var s = _v2.a;
				return $author$project$App$Success(s);
			default:
				var f = _v2.a;
				return $author$project$App$Finished(f);
		}
	}
};
		...
		switch (msg.$) {
			case 'TextInput':
				...
				return _Utils_Tuple2(
					...
					$elm$core$Platform$Cmd$none);
			case 'LoadProgram':
				var _v1 = $author$project$App$parseProgram(model.rawCode);
				if (_v1.$ === 'Ok') {
					var program = _v1.a;
					return _Utils_Tuple2(
						_Utils_update(
							model,
							{
								state: $author$project$App$Executing(
									{
										machineState: A2(
											$author$project$App$startingState,
											A2(
												$elm$core$List$map,
												$author$project$App$Value,
												_List_fromArray(
													[15, 10, 5, 4, 3, 2, 1])),
											program),
										program: program
					...
					return _Utils_Tuple2(
						_Utils_update(
							...
							{
								state: A2(
									$author$project$App$MainPage,
									model.rawCode,
									'Error in line' + $elm$core$String$fromInt(lineNum + 1))
							}),
						$elm$core$Platform$Cmd$none);
				}
			default:
				...
				if (_v2.$ === 'MainPage') {
					...
					var executionState = _v2.a;
					var _v3 = $author$project$App$step(executionState);
					switch (_v3.$) {
						case 'Finished':
							var machineState = _v3.a;
							return _Utils_Tuple2(
								_Utils_update(
									model,
									{
						...
						default:
							...
							return _Utils_Tuple2(
								_Utils_update(
									model,
									{
										state: A2($author$project$App$MainPage, model.rawCode, err)
									}),
								$elm$core$Platform$Cmd$none);
					}
				}
...
var $author$project$App$LoadProgram = {$: 'LoadProgram'};
...
var $author$project$App$Step = {$: 'Step'};
var $author$project$App$stringOfVal = function (_v0) {
	var x = _v0.a;
	return $elm$core$String$fromInt(x);
};
var $author$project$App$showState = function (state) {
	if (state.$ === 'Executing') {
		var mstate = state.a;
		return A2(
												...
												[
													...
													_List_fromArray(
														[
															...
															$rundis$elm_bootstrap$Bootstrap$Button$onClick($author$project$App$Step)
														]),
													_List_fromArray(
														[
									...
									_List_fromArray(
										[
											...
											_List_fromArray(
												[
													$elm$html$Html$text(
													'Line num: ' + $elm$core$String$fromInt(mstate.machineState.lineNumber))
												]))
										])),
									A2(
									$rundis$elm_bootstrap$Bootstrap$Grid$row,
									...
									_List_fromArray(
										[
											...
											_List_fromArray(
												[
													$elm$html$Html$text(
													'Acc: ' + $author$project$App$stringOfVal(mstate.machineState.acc))
												]))
										])),
									A2(
									$rundis$elm_bootstrap$Bootstrap$Grid$row,
													...
													A2(
														...
														A2(
															...
															function (_v1) {
																var k = _v1.a;
																var v = _v1.b;
																return '(' + (k + (': ' + ($author$project$App$stringOfVal(v) + ')')));
															},
															$elm$core$Dict$toList(mstate.machineState.memory))))
												]))
										])),
									A2(
									$rundis$elm_bootstrap$Bootstrap$Grid$row,
											...
											_List_fromArray(
												[
													...
													A2(
														$elm$core$String$join,
														', ',
														A2($elm$core$List$map, $author$project$App$stringOfVal, mstate.machineState.printed)))
												]))
										])),
									A2(
									$rundis$elm_bootstrap$Bootstrap$Grid$row,
											...
											_List_fromArray(
												[
													...
													A2(
														$elm$core$String$join,
														', ',
														A2($elm$core$List$map, $author$project$App$stringOfVal, mstate.machineState.input)))
												]))
										]))
								]))
						]))
						...
						[
							...
							_List_fromArray(
								[
									...
									$rundis$elm_bootstrap$Bootstrap$Grid$row,
									_List_Nil,
									(!$elm$core$String$isEmpty(msg)) ? _List_fromArray(
										[
											A2(
											$rundis$elm_bootstrap$Bootstrap$Grid$col,
											_List_Nil,
			...
			[
				...
				_List_fromArray(
					[
										...
										_List_fromArray(
											[
												...
												_List_fromArray(
													[
														$rundis$elm_bootstrap$Bootstrap$Button$primary,
														$rundis$elm_bootstrap$Bootstrap$Button$onClick($author$project$App$LoadProgram)
													]),
												_List_fromArray(
													[
									...
									[
										...
										_List_fromArray(
											[
												...
												_List_fromArray(
													[
														$rundis$elm_bootstrap$Bootstrap$Form$Textarea$rows(
														A2(
															$elm$core$Basics$max,
															10,
															$elm$core$List$length(
																$elm$core$String$lines(model.rawCode)) + 5)),
														$rundis$elm_bootstrap$Bootstrap$Form$Textarea$value(model.rawCode),
														$rundis$elm_bootstrap$Bootstrap$Form$Textarea$onInput($author$project$App$TextInput)
													]))
											]))
									])),
								A2(
						...
						_List_fromArray(
							[
								$author$project$App$showState(model.state)
							]))
					]))
			]));
};
...
_Platform_export({'App':{'init':$author$project$App$main(
	$elm$json$Json$Decode$succeed(_Utils_Tuple0))({"versions":{"elm":"0.19.1"},"types":{"message":"App.Msg","aliases":{},"unions":{"App.Msg":{"args":[],"tags":{"TextInput":["String.String"],"LoadProgram":[],"Step":[]}},"String.String":{"args":[],"tags":{"String":[]}}}}})}});}(this));